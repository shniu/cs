...
交易所本质解决的现实问题就是实现**用户进行下单买卖，维持用户的交易深度，撮合交易单成交，最后完成清算划转。**
...
交易所的处理交易量会很大，除了常见的**数据库增删改查操作优化要做，比如分库、分表**。分表常见的是按日期处理，所有的交易所查询历史订单都不会无限制，一般几个月之内的可以查到，超出几个月则无法查询。
...
* \*\*\*\*[**内存格系统 Hazelcast 在交易系统中的应用**](https://gitbook.cn/books/5cfe0ab2c73a7a7d077d0c05/index.html)  **- TODO**
